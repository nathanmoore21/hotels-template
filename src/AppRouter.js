...
import GuestConfirmation from "./pages/GuestConfirmation"; // Import the GuestConfirmation component
  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/guestconfirmation" element={<GuestConfirmation />} />
        <Route path="/payments" element={<Payments />} />
        {/* // path for each hotel */}
        <Route path="/hotel/:name" element={<HotelPage hotels={hotelData} />} />
         {/* Add the PageNotFound route */}
